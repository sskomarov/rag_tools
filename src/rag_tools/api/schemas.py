...
class RAGMetricsRequest(BaseModel):
    relevant: List[List[int]] = Field(..., description="Per-question list of relevant ids")
    predicted: List[List[int]] = Field(..., description="Per-question ranked list of predicted ids")
